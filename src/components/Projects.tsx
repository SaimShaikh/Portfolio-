...
const projects = [
  {
    ...
    description: 'Observability helps teams understand system behavior through logs, metrics, and traces, making debugging easier.',
    link: 'https://github.com/SaimShaikh/observability-', // Ensure this is a valid GitHub repo URL
    image: '/images/ober.png'
  },
  {
    title: 'Automated Kubernetes Deployment',
    description: 'Orchestrated deployments via Kubernetes Dashboard ensuring efficient resource utilization.',
    link: 'https://github.com/SaimShaikh/Bank-Application-Deployment-using-DevSecOps-on-AWS-EKS', // Ensure this is correct
    image: '/images/cbank.png'
  },
  {
    title: 'WanderLust Blog Web-Application',
    description: 'A simple MERN travel blog website to help developers contribute to open-source and upskill in React.',
    link: 'https://github.com/SaimShaikh/Wanderlust-Mega-Project', // Ensure this works
